            ...
            <div className="popup__content">
                ...
                <form id="login-form" className="popup__form" name="login-form" onSubmit={handleSubmit}>
                    <div className="popup__info">
                        ...
                        <input id="email" ref={emailRef} className="popup__input" name="login" type="text" placeholder="Email" required value="pochta@yandex.ru" />
                        <label className="popup__label">Пароль</label>
                        <input id="password" ref={passwordRef} className="popup__input_password" name="password" type="password" required />
                    </div>
